...
img = [Image.open(os.path.join(input_images_dir, filename)).convert("RGB") for filename in img_files]
with open(descriptions_csv, newline='', encoding='utf-8') as csvfile:
    ...
    n_augmentations = 3
    output_csv = os.path.join(output_images_dir, "descriptions_augmentees.csv")
